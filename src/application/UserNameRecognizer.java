...
/**
 * The {@code UserNameRecognizer} class implements a finite state machine (FSM) to validate usernames.
 * Usernames must begin with a letter and may contain letters, digits, '.', '-', or '_', with length 4–16 characters.
 */
