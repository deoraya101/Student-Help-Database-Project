 ...
 */
/**
 * The {@code FirstPage} class represents the initial screen shown when the application
 * is launched for the first time. It prompts the first user to set up administrator access.
 */
...
public class FirstPage {
	...
	/**
 * Constructs the first landing page with DB access.
