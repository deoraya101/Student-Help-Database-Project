...
/**
 * The {@code PasswordEvaluator} class validates passwords using a directed graph-based
 * finite state machine. It checks for complexity rules such as:
 * uppercase, lowercase, digits, special characters, and length.
 */
...
public class PasswordEvaluator {
	 ...
	 */
	/**
 * Displays the input line with an arrow pointing at the error index.
 */
private static void displayInputState() {
	 ...
	 */
	/**
 * Evaluates a password against complexity rules using a directed graph logic.
 * @param input the password string
 * @return an error message if the password is invalid, or an empty string if valid
 */
