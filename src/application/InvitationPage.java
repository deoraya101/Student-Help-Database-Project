...
/**
 * The {@code InvitationPage} class provides a UI for administrators to generate
 * invitation codes that new users can use to register.
 */

/**
 * The {@code InvitationPage} class displays a UI for students to invite instructors
 * to review their submitted questions. Instructors can be chosen from a dropdown.
 */
public class InvitationPage {
     ...
     */
    public void show(DatabaseHelper databaseHelper,Stage primaryStage, User user) { // Talyor edit 2/18
        ...
        layout.getChildren().addAll(userLabel, showCodeButton, inviteCodeLabel, returnButton); // Talyor edit 2/18
